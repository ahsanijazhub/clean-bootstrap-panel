<div class="content-header">
    <h1><?= htmlspecialchars($page_title ?? 'Edit Permission') ?></h1>
</div>
                    ...
                    <div class="card-body">
                            ...
                            <select name="permission_group_id" class="form-control" required>
                                ...
                                <?php foreach ($groups as $group): ?>
                                    <option value="<?= $group->id ?>"
                                        <?= $permission->permission_group_id == $group->id ? 'selected' : '' ?>>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="perm_name" class="form-control" required
                                   value="<?= htmlspecialchars($permission->perm_name) ?>"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="perm_slug" class="form-control" required
                                   value="<?= htmlspecialchars($permission->perm_slug) ?>"
